  ...
  static Map<JanarymMode, ModeDescriptor> _buildDescriptors() {
    return <JanarymMode, ModeDescriptor>{
      ...
      JanarymMode.anti_fraud: ModeDescriptor(
        ...
        prompts: const ModePromptProfile(
          blindRu:
              'Это anti_fraud режим. Проверяй сумму, сдачу, чек, цену и возможное несоответствие. Отвечай строго и коротко.',
          blindKk:
              'Бұл anti_fraud режимі. Соманы, қайтарымды, чекті, бағаны және ықтимал сәйкессіздікті тексер. Қысқа әрі нақты жауап бер.',
          visionRu:
              'Это anti_fraud режим. Проверяй банкноты, чек, цену и подозрительные расхождения без лишнего описания сцены.',
          visionKk:
              'Бұл anti_fraud режимі. Купюраны, чекті, бағаны және күмәнді айырмашылықтарды сахнаны артық сипаттамай тексер.',
        ),
      ),
